...
window.SCHOOL = {
  ...
  font:    'roboto',
  layout:  'layout0',
  modules: ["students","staff","classes","attendance","results","timetable","sow","cbt","report-cards","timetable-generator","checkin","assignments","promotion","lms","lesson_plans","behaviour","support_plans","analytics","admin-data","settings","admissions","hr","certificates","diary","announcements","surveys","messages","inbox","complaints","broadcast","voting","parent_meeting","gallery","eresources","birthdays","idcards","flyer","reports","directory","departments","parents","school_calendar","lost_found","fees","finance","leave","financial_aid","payments_online"],
...
console.log('%c[God of Seed Academy ] School Connect ready.', 'color:#9e31b9;font-weight:bold;font-size:13px');
